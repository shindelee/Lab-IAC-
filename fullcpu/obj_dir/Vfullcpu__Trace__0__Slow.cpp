...
VL_ATTR_COLD void Vfullcpu___024root__trace_init_sub__TOP__0(Vfullcpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+81,"DATAOUT_WIDTH", false,-1, 31,0);
    tracep->declBit(c+72,"PCsrc", false,-1);
    tracep->declBit(c+78,"clk", false,-1);
    tracep->declBit(c+79,"rst", false,-1);
    tracep->declBus(c+73,"ImmOp", false,-1, 31,0);
    ...
    tracep->declBus(c+83,"address_width", false,-1, 31,0);
    tracep->declBus(c+34,"instr", false,-1, 6,0);
    tracep->declBit(c+74,"EQ", false,-1);
    tracep->declBit(c+30,"RegWrite", false,-1);
    tracep->declBus(c+31,"ALUctrl", false,-1, 2,0);
    tracep->declBit(c+32,"ALUsrc", false,-1);
    ...
    tracep->declBus(c+77,"ALUop2", false,-1, 31,0);
    tracep->declBus(c+39,"regOp2", false,-1, 31,0);
    ...
    tracep->declBus(c+81,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBit(c+78,"clk", false,-1);
    tracep->declBus(c+35,"addr1", false,-1, 4,0);
    tracep->declBus(c+36,"addr2", false,-1, 4,0);
    tracep->declBus(c+37,"addr3", false,-1, 4,0);
...
VL_ATTR_COLD void Vfullcpu___024root__trace_full_sub_0(Vfullcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+33,(vlSelf->fullcpu__DOT__blue__DOT__A),32);
    bufp->fullCData(oldp+34,((0x7fU & vlSelf->fullcpu__DOT__Instr)),7);
    bufp->fullCData(oldp+35,((0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                       >> 0xfU))),5);
    bufp->fullCData(oldp+36,((0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                       >> 0x14U))),5);
    bufp->fullCData(oldp+37,((0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                       >> 7U))),5);
    bufp->fullIData(oldp+38,(vlSelf->fullcpu__DOT__topregalu__DOT__ALUop1),32);
    bufp->fullIData(oldp+39,(((0U == (0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                               >> 0x14U)))
                               ? 0U : vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array
                              [(0x1fU & (vlSelf->fullcpu__DOT__Instr 
                                         >> 0x14U))])),32);
    bufp->fullIData(oldp+40,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[0]),32);
    bufp->fullIData(oldp+41,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[1]),32);
    bufp->fullIData(oldp+42,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[2]),32);
    bufp->fullIData(oldp+43,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[3]),32);
    bufp->fullIData(oldp+44,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[4]),32);
    bufp->fullIData(oldp+45,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[5]),32);
    bufp->fullIData(oldp+46,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[6]),32);
    bufp->fullIData(oldp+47,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[7]),32);
    bufp->fullIData(oldp+48,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[8]),32);
    bufp->fullIData(oldp+49,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[9]),32);
    bufp->fullIData(oldp+50,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[10]),32);
    bufp->fullIData(oldp+51,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[11]),32);
    bufp->fullIData(oldp+52,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[12]),32);
    bufp->fullIData(oldp+53,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[13]),32);
    bufp->fullIData(oldp+54,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[14]),32);
    bufp->fullIData(oldp+55,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[15]),32);
    bufp->fullIData(oldp+56,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[16]),32);
    bufp->fullIData(oldp+57,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[17]),32);
    bufp->fullIData(oldp+58,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[18]),32);
    bufp->fullIData(oldp+59,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[19]),32);
    bufp->fullIData(oldp+60,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[20]),32);
    bufp->fullIData(oldp+61,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[21]),32);
    bufp->fullIData(oldp+62,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[22]),32);
    bufp->fullIData(oldp+63,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[23]),32);
    bufp->fullIData(oldp+64,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[24]),32);
    bufp->fullIData(oldp+65,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[25]),32);
    bufp->fullIData(oldp+66,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[26]),32);
    bufp->fullIData(oldp+67,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[27]),32);
    bufp->fullIData(oldp+68,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[28]),32);
    bufp->fullIData(oldp+69,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[29]),32);
    bufp->fullIData(oldp+70,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[30]),32);
    bufp->fullIData(oldp+71,(vlSelf->fullcpu__DOT__topregalu__DOT__RegFile__DOT__ram_array[31]),32);
    bufp->fullBit(oldp+72,(vlSelf->fullcpu__DOT__PCsrc));
    bufp->fullIData(oldp+73,(vlSelf->fullcpu__DOT__ImmOp),32);
    bufp->fullBit(oldp+74,(vlSelf->fullcpu__DOT__EQ));
    bufp->fullBit(oldp+75,(vlSelf->fullcpu__DOT__ImmSrc));
    bufp->fullIData(oldp+76,(vlSelf->fullcpu__DOT__topregalu__DOT__ALUout),32);
    bufp->fullIData(oldp+77,(vlSelf->fullcpu__DOT__topregalu__DOT__ALUop2),32);
    bufp->fullBit(oldp+78,(vlSelf->clk));
    bufp->fullBit(oldp+79,(vlSelf->rst));
    bufp->fullIData(oldp+80,(vlSelf->a0),32);
    bufp->fullIData(oldp+81,(0x20U),32);
    bufp->fullIData(oldp+82,(8U),32);
    bufp->fullIData(oldp+83,(7U),32);
