...
VL_ATTR_COLD void Vfullcpu___024root__trace_init_sub__TOP__0(Vfullcpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+79,"ImmSrc", false,-1, 2,0);
    ...
    tracep->declBus(c+86,"DATAOUT_WIDTH", false,-1, 31,0);
    tracep->declBit(c+76,"PCsrc", false,-1);
    tracep->declBit(c+82,"clk", false,-1);
    tracep->declBit(c+83,"rst", false,-1);
    tracep->declBus(c+77,"ImmOp", false,-1, 31,0);
    ...
    tracep->declBus(c+81,"ALUop2", false,-1, 31,0);
    tracep->declBus(c+41,"regOp2", false,-1, 31,0);
    tracep->declBus(c+85,"ReadData", false,-1, 31,0);
    ...
    tracep->declBus(c+77,"d1", false,-1, 31,0);
    ...
    tracep->declBus(c+80,"wd3", false,-1, 31,0);
    ...
    tracep->declBus(c+86,"DATA_WIDTH", false,-1, 31,0);
    tracep->declBus(c+80,"d0", false,-1, 31,0);
    tracep->declBus(c+85,"d1", false,-1, 31,0);
    ...
    tracep->declBus(c+85,"rd", false,-1, 31,0);
    for (int i = 0; i < 2; ++i) {
        tracep->declBus(c+74+i*1,"ram_array", true,(i+-1), 31,0);
    }
...
VL_ATTR_COLD void Vfullcpu___024root__trace_full_sub_0(Vfullcpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+74,(vlSelf->fullcpu__DOT__topregalu__DOT__datamemory__DOT__ram_array[0]),32);
    bufp->fullIData(oldp+75,(vlSelf->fullcpu__DOT__topregalu__DOT__datamemory__DOT__ram_array[1]),32);
    bufp->fullBit(oldp+76,(vlSelf->fullcpu__DOT__PCsrc));
    bufp->fullIData(oldp+77,(vlSelf->fullcpu__DOT__ImmOp),32);
    bufp->fullBit(oldp+78,(vlSelf->fullcpu__DOT__EQ));
    bufp->fullCData(oldp+79,(vlSelf->fullcpu__DOT__ImmSrc),3);
    bufp->fullIData(oldp+80,(vlSelf->fullcpu__DOT__topregalu__DOT__ALUout),32);
    bufp->fullIData(oldp+81,(vlSelf->fullcpu__DOT__topregalu__DOT__ALUop2),32);
    bufp->fullBit(oldp+82,(vlSelf->clk));
    bufp->fullBit(oldp+83,(vlSelf->rst));
    bufp->fullIData(oldp+84,(vlSelf->a0),32);
    bufp->fullIData(oldp+85,(vlSelf->fullcpu__DOT__topregalu__DOT__datamemory__DOT__ram_array
