...
VL_ATTR_COLD void Vfullcpu___024root___settle__TOP__0(Vfullcpu___024root* vlSelf) {
    ...
    // Body
    vlSelf->fullcpu__DOT__topregalu__DOT__datamemory__DOT__ram_array[0U] = 0x12345U;
...
VL_ATTR_COLD void Vfullcpu___024root___settle__TOP__1(Vfullcpu___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vfullcpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vfullcpu___024root___settle__TOP__1\n"); );
    // Body
...
VL_ATTR_COLD void Vfullcpu___024root___eval_settle(Vfullcpu___024root* vlSelf) {
    ...
    vlSelf->__Vm_traceActivity[1U] = 1U;
    vlSelf->__Vm_traceActivity[0U] = 1U;
    Vfullcpu___024root___settle__TOP__1(vlSelf);
}
